...
cover_image: /assets/img/featured/thomas-kvistholt-191153.jpg
---
...
![](/assets/img/aws/c66e5bc3-67a8-48f3-ab42-986e8ec87a95.png)

Select the **Amazon Linux AMI 2017.03.1 (HVM), SSD Volume Type** (version correct at time of writing).

![](/assets/img/aws/a45fb5e3-fc9e-4bc6-8291-784eeed7764d.png)

For the purposes of this tutorial, the default selection (**t2.micro**) is fine (and eligible for the free usage tier!)

![](/assets/img/aws/616d56ad-c455-46fd-9fdc-f3fe1562ae92.png)

Skip both the Step 3 (Configure Instance Details) and Step 4 (Add Storage) - they have sensible defaults.

In Step 5 (Add Tags) give your instance a name by clicking _click to add a Name tag_. Can't think of a name? Check out out some fun suggestions at [https://haikunator.cloudstage.me/](https://haikunator.cloudstage.me/).

![](/assets/img/aws/9bbee1fb-8b30-453e-830f-59fabb250ff4.png?w=1200)
...
![](/assets/img/aws/b3fe42e9-df8a-4758-9d3d-7fbae6ebee07.png?w=1200)
...
![](/assets/img/aws/5c9d5d55-57c0-4558-886a-bb78f0f6c3b8.png?w=1200)
...
In the first instance, to access the server (and your new WordPress installation) in a browser, you can either use the _Public DNS_ URL (something like _ec2-52-63-199-239.ap-southeast-2.compute.amazonaws.com_) or use a service such as [CloudStage](https://cloudstage.me) to quickly create a more memorable staging domain - just enter your instance's IP address.

![](../Media/cloudstage.png)
