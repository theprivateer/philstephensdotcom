...
![](/assets/img/domain-dictionary1.png)
...
I need to get back to my day job now, but in the meantime you can view the source code for this [on Github](https://github.com/theprivateer/domain-dictionary) and browse the end result at [http://domaindictionary.cloudstage.me](http://domaindictionary.cloudstage.me).
