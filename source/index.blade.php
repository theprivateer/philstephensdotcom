...
@section('body')
    ...
    <p class="mb-6">I mostly write about <a href="/blog">bikes and life</a>, but also the odd bit of <a href="/dev">web development</a>.  I also occasionally post <a href="/stream">snippets from my daily life</a>.</p>
